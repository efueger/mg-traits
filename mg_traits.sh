...
source ~/.bashrc
source /bioinf/home/epereira/workspace/mg-traits/resources/config_files/config.bash
source /bioinf/home/epereira/workspace/mg-traits/resources/config_files/config.proxy
...
rm -r /bioinf/projects/megx/scratch/mg-traits/running_jobs/job-83*
...
qsub -pe threaded $NSLOTS -l h=\!mg32 -N $FINISHJOBID -o $THIS_JOB_TMP_DIR -e $THIS_JOB_TMP_DIR -l ga -j y -terse -P megx.p -R y -m sa -M $mt_admin_mail \
-hold_jid $FGS_JOBARRAYID,$SINA_JOBARRAYID  /bioinf/home/epereira/workspace/mg-traits/resources/bin/finish_runner.sh $THIS_JOB_TMP_DIR
