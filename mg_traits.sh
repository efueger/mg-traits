...
mg_traits_dir="/megx/software/mg-traits"
temp_dir="/megx/data/megx-portal/mg-traits"
job_out_dir="/vol/tmp/megx/"
mt_admin_mail="afernand@mpi-bremen.de,rkottman@mpi-bremen.de"
cd_hit_dup="/usr/local/software/cd-hit-auxtools-v0.5/cd-hit-dup"
cd_hit_dup_version="0.5"
cd_hit_est="/usr/local/software/cd-hit-4.6.1/cd-hit-est"
cd_hit_mms="/usr/local/software/cd-hit-4.6.1/make_multi_seq.pl"
cd_hit_version="4.6.1"
frag_gene_scan="/usr/local/software/FGS/run_FragGeneScan.pl"
frag_gene_scan_version="1.15-mod"
uproc_version="1.1.1"
uproc="/megx/software/upro/${uproc_version}/bin/uproc-dna"
uproc_pfam="/vol/biodb/uproc/pfam27"
uproc_pfam_version="pfam27"
uproc_model="/vol/biodb/uproc/model"
sina="/megx/software/sina-1.2.13/sina"
sina_arb_pt_server="/megx/software/sina-1.2.13/lib/arb_pt_server"
sina_version="1.2.13"
...
ARBHOME="/megx/software/sina-1.2.13"
LD_LIBRARY_PATH="/megx/software/sina-1.2.13/lib"
r_interpreter="/megx/software/R/3.0.2/bin/R"
r_interpreter_version="3.0.2"
